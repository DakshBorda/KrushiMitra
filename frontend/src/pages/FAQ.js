              ...
              <div class="w-full lg:w-1/2 px-4 py-2">
                <details class="mb-4">
                  ...
                  <span className="text-justify">
                    You can sell your Farm Equipment by listing it on KrushiMitra website or KrushiMitra mobile applications.
                  </span>
                </details>
                <details class="mb-4">
                  ...
                  <span className="text-justify">
                    Listing on KrushiMitra is quite easy. Just click on the
                ...
                <details class="mb-4">
                  ...
                  <span className="text-justify">
                    ...
                    KrushiMitra website or mobile applications. Don’t forget
              ...
              <div class="w-full lg:w-1/2 px-4 py-2">
                <details class="mb-4">
                  ...
                  <span class="px-4 py-2 text-justify">
                    ...
                    providers are open to selling equipment on KrushiMitra
                    with a fair deal.
                  </span>
                </details>
                <details class="mb-4">
                  <summary class="font-semibold  bg-gray-200 rounded-md py-2 px-4">
                    I don't have a website, Can I still sell on KrushiMitra?
                  </summary>

                  <span class="px-4 py-2 text-justify">
                    You don't need a website to start selling on KrushiMitra.
